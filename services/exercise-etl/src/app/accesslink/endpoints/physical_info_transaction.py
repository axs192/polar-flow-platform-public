...
from src.app.accesslink.endpoints.transaction import Transaction
...
class PhysicalInfoTransaction(Transaction):
    def list_physical_infos(self):
        ...
        return self._get(endpoint=None, url=self.transaction_url, access_token=self.access_token)
